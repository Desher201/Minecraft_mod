...
public class RunnerRoleAI {
    ...
    public static void tick(Mob mob) {
        ...
        if (!ZombiePositioningHelper.shouldRepath(mob, "ZapocRunnerRepathTick", 17))
            return;
        ...
        double radius = 2.0D + (Math.abs(mob.getId()) % 4) * 0.5D;
